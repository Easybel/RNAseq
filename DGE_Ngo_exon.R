...
setwd("/home/isabel/Dokumente/ExpEvol/Neisseria/Analysis/exon/")
outName = "RefCtlExon_queriedAzi_resNamed_sort.csv"

#####################
## Ngo -- here the data is loaded and columns are added with sum, mean, median
tab <- read.table("/home/isabel/Dokumente/ExpEvol/Neisseria/Analysis/exon/Ngo_exon_Counts.csv", sep=" ", header = TRUE)
geneInfo <- read.csv("/home/isabel/Dokumente/ExpEvol/Neisseria/dictionaries/MS11_ncbi_IR/FilterLists/MS11_GenesAndProducts_exon.txt", sep=" ", header = FALSE)

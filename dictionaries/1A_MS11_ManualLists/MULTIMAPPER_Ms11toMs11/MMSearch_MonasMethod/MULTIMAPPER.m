...
blastn.path = '/home/isabel/Dokumente/ExpEvol/Neisseria/dictionaries/MS11_ncbi_IR/multimapper/';
blastn.recipname = 'Ms11';
blastn.recip = 'Ms112Ms11_blast';
blastn.donorname = '';
blastn.donor = '';
...
ListRegion(:,3) =  ListRegion(:,2) - ListRegion(:,1) +1;

Listmask = ListRegion(:,3) >= minLen;

output.nameList = [output.path, blastn.recipname, '_mm_regions.txt'];
